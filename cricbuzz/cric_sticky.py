#!/bin/python
import urllib, urllib2,re,bs4,cookielib,sys,time,unicurses
...
def printLiveCricketScore(CricketObjectInLopp):
 ...
 display(finalStringToprint)

def display(stringtodispaly):
    stdscr = unicurses.initscr()
    unicurses.clear()
    unicurses.move (0,0)
    unicurses.addstr(stringtodispaly)
    time.sleep(60)
    unicurses.endwin()
...
if __name__ == '__main__':
  ...
  towaitSec=1
  while IsMatchLive:
   print ( str (count * towaitSec) + ' Live')
